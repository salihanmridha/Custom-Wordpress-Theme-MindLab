  ...
  register_sidebar(
    ...
    register_sidebar(
      ...
      register_sidebar(
        ...
        //registering second footer sidebar widget
        register_sidebar(
          array(
              'name'          => esc_html__( 'Second Footer Sidebar', 'mindlabtheme' ),
              'id'            => 'mindlab-second-footer-sidebar',
              'description'   => 'Second footer sidebar for the theme',
              'before_widget' => '<div class="col-sm-4 col-sm-offset-1 footer-menu">',
              'after_widget'  => '</div>',
              'before_title'  => '<h5>',
              'after_title'   => '</h5>',
          ));

        //registering third footer sidebar widget
        register_sidebar(
          array(
              'name'          => esc_html__( 'Third Footer Sidebar', 'mindlabtheme' ),
              'id'            => 'mindlab-third-footer-sidebar',
              'description'   => 'Third footer sidebar for the theme',
              'before_widget' => '<div class="col-sm-3 text-right">',
              'after_widget'  => '</div>',
              'before_title'  => '<h5>',
              'after_title'   => '</h5>',
          ));
