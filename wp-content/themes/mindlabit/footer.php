...
<section class="section-small footer bg-gray">
  <div class="container">
    <div class="row">
      ...
      <?php
        if (is_active_sidebar( 'mindlab-second-footer-sidebar' )): dynamic_sidebar( 'mindlab-second-footer-sidebar' );
        endif;
      ?>

      <?php
        if (is_active_sidebar( 'mindlab-third-footer-sidebar' )): dynamic_sidebar( 'mindlab-third-footer-sidebar' );
        endif;
      ?>
