...
(function($){
    ...
    $('#mindlab-contact-form').on('submit', function(e){
      e.preventDefault();
      var form = $(this),
          ajaxurl = form.data('url'),
          name = form.find('#mindlab-contact-name-id').val(),
          email = form.find('#mindlab-contact-email-id').val(),
          phone = form.find('#mindlab-contact-phone-id').val(),
          msg = form.find('#mindlab-contact-msg-id').val();
      ...
      $.ajax({
        ...
        data : {
          ...
          phone : phone,
          msg : msg,
          action : 'mindlab_contact_frm_send'
        },
